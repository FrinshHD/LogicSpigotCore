...
public abstract class BasicCommand extends Command {
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String commandLabel, @NotNull String[] args) {
        ...
        BasicSubCommand subCommand = LogicSpigotCoreMain.getCommandManager().getSubCommand(this, args);
    ...
    public List<String> tabComplete(@NotNull CommandSender sender, @NotNull String alias, @NotNull String[] args) throws IllegalArgumentException {
        ...
        if (args.length <= 1) {
            ...
            List<BasicSubCommand> basicSubCommands = LogicSpigotCoreMain.getCommandManager().getSubCommands(this);
