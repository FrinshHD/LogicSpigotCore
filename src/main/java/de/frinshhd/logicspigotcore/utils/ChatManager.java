...
public class ChatManager {
    ...
    public static boolean sendMessageRaw(CommandSender sender, String message) {
        ...
        if (sender instanceof Player player && Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null && LogicSpigotCoreMain.getInstance().getServer().getPluginManager().getPlugin("PlaceholderAPI").isEnabled()) {
